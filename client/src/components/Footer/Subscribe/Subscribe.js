    ...
    return (
      <div>
        <p className="footer-menu-list-header">Subscribe to newsletter</p>
          <input className="subscribe-input" type="text" name="email" placeholder="ENTER YOUR EMAIL" onChange={this.onInputChange.bind(this)}/>
        <div className="subscribe-submit" onClick={this.onSubscribe.bind(this)}>SUBSCRIBE</div>
      </div>
    )
  }
}
